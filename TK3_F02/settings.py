"""
Django settings for TK3_F02 project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-@9quvb4=9lb53-1q#jophaxod5ye97pwz7!q@_2#ge&=7o7z$$')
...
WSGI_APPLICATION = 'TK3_F02.wsgi.application'
